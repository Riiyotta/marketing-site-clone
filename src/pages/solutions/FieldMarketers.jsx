...
/* /solutions/by-role/field-marketers — one of the six routes driven by the shared
   Solutions > By Role template. All content lives in solutionsPages.js,
   captured verbatim from live. */
export default function FieldMarketers() {
  return <RoleTemplate page={ROLE_PAGES['field-marketers']} />
}
